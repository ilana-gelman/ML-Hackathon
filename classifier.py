...
# Y include the response of all the sampels
#only unique labels
...
def load_data_and_spilt(filename_train, filename_labels_0, filename_labels_1):
    ...
    # identifies and removes duplicate rows based on specific columns, and updates the train DataFrame to contain only non - duplicate
